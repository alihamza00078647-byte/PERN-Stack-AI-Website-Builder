        ...
        <>
          <div className="w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]">
            <div className="text-center mt-16">
                ...
                <p className="text-sm text-gray-400 max-w-md mx-auto mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto aliquid perferendis accusantium.</p>
            </div>
            <div className='pt-14 py-4 px-4 mb-10'>
                ...
                <p className="text-sm text-center mx-auto my-20 max-w-md mt-10 text-white/60 font-light">
                  <span className="text-white font-bold">Project Creation / Revision</span> consumes{" "}
                  <span className="text-white font-bold">5 credits</span>. You can purchase more
                  credits anytime to create additional projects.
                </p>
          </div>  
        </>
    )
